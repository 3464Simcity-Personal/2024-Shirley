...
public class DrivetrainSubsystem extends SubsystemBase {
  ...
  private final CANSparkMax
    leftFront = new CANSparkMax(DrivetrainConstants.kLeftFrontPort, CANSparkLowLevel.MotorType.kBrushless),
    leftBack = new CANSparkMax(DrivetrainConstants.kLeftBackPort, CANSparkLowLevel.MotorType.kBrushless),
    rightFront = new CANSparkMax(DrivetrainConstants.kRightFrontPort,  CANSparkLowLevel.MotorType.kBrushless),
    rightBack = new CANSparkMax(DrivetrainConstants.kRightBackPort,  CANSparkLowLevel.MotorType.kBrushless);
